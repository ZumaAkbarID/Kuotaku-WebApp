...
<head>
  ...
  <title>Lupa Password &mdash; Kuotaku</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <p class="text-muted">Kami akan mengirimkan password baru ke email anda.</p>
                <form method="POST">
                  ...
                  <div class="text-center">
                    <p>Memiliki akun? <a href="login.php">Login</a></p>
                  </div>
                </form>
              </div>
            </div>
