...
session_start();
  ...
  if(isset($_POST['sendChat'])) {
    $who = $_POST['kpd'];
    $texts = $_POST['texts'];
    $sendingChat = mysqli_query($koneksi, "INSERT INTO pesan(nama,dari,chat,dattim,baca) VALUES('$who','$nama','$texts','$tanggal','0')");
...
<head>
  ...
  <title>Chat &mdash; Kuotaku</title>
    ...
    <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Send Chat</h2>
            <p class="section-lead">
              Kirim chatmu ke pengguna lain.
            </p>
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="form-group">
                        ...
                        <input type="text" class="form-control" required name="kpd" data-toggle="tooltip" title="Nama wajib sama dengan milik pengguna">
                        <div class="invalid-feedback">
                                Aku tanya, Kepada siapa?
                        </div>
                  </div>
                <div class="form-group mb-0">
                    <label>Apa pesannya?</label>
                            <textarea type="text" class="form-control" required="" 
                             name="texts"></textarea>
                                    <div class="invalid-feedback">
                                        Beritahu aku agar aku dapat menyampaikannya.
                                    </div>
                                </div>
                            </div>
                        <div class="card-footer text-right">
                            <button class="btn btn-primary" name="sendChat">Simpan</button>
                          </div>
                        </form>
                      </div>
                    </div>
